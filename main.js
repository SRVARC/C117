...
var answer_holder = "";
 var score = "";
//result = random_number(quick_draw_data_set);
//console.log(result);
...
function gotResults(error , results)
{
    ...
    document.getElementById('sketch_to_be_drawn').innerHTML = 'Sketch To Be Drawn:' +  quick_draw_data_set[random_number].label;
